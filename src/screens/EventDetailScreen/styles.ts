...
export const s = StyleSheet.create({
  ...
  locationLabel: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingBottom: 16, gap: 10 },
  ...
  openMapsButton: { minHeight: 40, borderRadius: 14, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', gap: 5 },
  openMapsText: { fontSize: 12, fontWeight: '700' },
